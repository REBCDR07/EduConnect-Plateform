            ...
            <div className="relative group mb-8 lg:mb-12">
              ...
              <div className="relative bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-3xl shadow-xl border border-white/30 dark:border-gray-700/30 p-8 sm:p-10 lg:p-12">
                ...
                <div className="relative w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 mx-auto mb-6 lg:mb-8">
                  ...
                  <div className="absolute inset-2 border-4 border-transparent border-b-purple-500 dark:border-b-purple-400 rounded-full animate-spin" style={{ animationDirection: 'reverse', animationDuration: '1.2s' }}></div>
                  <div className="absolute inset-4 border-4 border-transparent border-l-emerald-500 dark:border-l-emerald-400 rounded-full animate-spin" style={{ animationDuration: '1.1s' }}></div>
